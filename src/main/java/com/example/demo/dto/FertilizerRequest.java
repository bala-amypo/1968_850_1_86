...
public class FertilizerRequest {
    ...
    public static FertilizerRequestBuilder builder() { return new FertilizerRequestBuilder(); }
    ...
    public static class FertilizerRequestBuilder {
        ...
        public FertilizerRequest build() { return new FertilizerRequest(name, npkRatio, recommendedForCrops); }
    }
}